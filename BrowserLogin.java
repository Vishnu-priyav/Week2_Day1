...
public class BrowserLogin {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Vishnupriya");
		driver.findElement(By.id("createLeadForm_departmentName")).sendKeys("Information Technology");
		driver.findElement(By.id("createLeadForm_description")).sendKeys("Vishnupriya VK from Information Technology Department");
		driver.findElement(By.name("primaryEmail")).sendKeys("Vishnupriyav271@gmail.com");		
